  ...
  return (
    <div>
      <div className="flex-col justify-center flex-wrap gap-6 sm:gap-0 sm:flex-row flex  sm:justify-around w-[80%] m-auto my-10">
        <div className=" flex-col gap-3  items-center justify-between px-mx-3 sm:mx-0  w-[250px] h-[150px] rounded-lg bg-blue-100">
          ...
          <p className="font-semibold text-lg ms-4 mt-3">
            Orders
            <br />
            Compleeted
          </p>
        ...
        <div className=" flex-col gap-3  items-center justify-between px-mx-3 sm:mx-0  w-[250px] h-[150px] rounded-lg bg-pink-100">
          <div className="flex items-center gap-4 ms-3 mt-3">
            <div className="">
              <TbStars />
            </div>
